...
query_desc()
{
	...
	"spellrange of the caster. It is more powerful then the 'telar' " +
	"spell. Power manipulates the endurance of the spell.";
}
...
spell_effect(int level, object *tar, object tp)
{
	...
	ob->start_call_out("remove_spell", 60*(level-11));
    }
}
