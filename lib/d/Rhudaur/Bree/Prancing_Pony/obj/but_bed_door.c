...
door_move(object ob, object from, object to)
{
    ...
    if (to->query_room_file() != BREE_PATH+"/Prancing_Pony/butterbur_bedroom")
    {
	set_direction_desc("leading into a room");
	set_connection(BREE_PATH+"/Prancing_Pony/butterbur_bedroom", 1);
    }
    else
    {
