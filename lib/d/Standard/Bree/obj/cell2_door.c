...
create_door()
{
    ...
    set_key("/d/Standard/Bree/obj/cell2_key");
...
door_move(object ob, object from, object to)
{
    ...
    if (to->query_room_file() == "/d/Standard/Bree/room/jail/cell2")
    {
    ...
    {
	set_direction_desc("leading into cell two");
	set_connection("/d/Standard/Bree/room/jail/cell2", 1);
    }
